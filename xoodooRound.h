...
public:
    ...
    XoodooRound(int round, int weight, int thread, int mode);//constructor
    ...
    bool read2States(States& res, ifstream &infile, int mode);//read a result state in a readable file, mode 0 for file generated by this programme, 1 for DC file generated by previous work(https://github.com/KeccakTeam/Xoodoo/tree/master/XooTools/Trails)
