...
$$3-round: a_0 -> b_0 -> a_1 -> b_1 -> a_2 -> b_2 -> a_3, b_i=lambda(a_i), a_{i+1}=chi(b_i)$$
$$3-round-trail-core: a_1 -> b_1 -> a_2 -> b_2$$
$$state-to-sum-weight: a_1, a_2, b_2 (a_1, a_2,..., a_{n-1}, b_{n-1})$$
$$3-round-weight = w(a_1)+w(a_2)+w(b_2)$$
